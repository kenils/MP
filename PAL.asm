...
msg8 db 10,13,"Not Palindrome$"
msg9 db 10,13,"Palindrome$"
choice db ?
len db ?
Data Ends
Code Segment
...
mov dx,offset msg5
mov ah,09h
int 21h          ;Displaying MENU

call input
mov choice,al   ;Take input choice
...
A:
mov ah,01h		;Accept String Input
int 21h
...
srev:                ;CHECK if palindrome or not
cmp choice,04h
jnz exit
mov si,1000h
mov ax,si
